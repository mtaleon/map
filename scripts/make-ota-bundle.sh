#!/bin/bash
# Build OTA bundle for Map Android WebView updates.
...
echo "[OTA] Building Map bundle v${VERSION}..."

# Core files needed for Map
OTA_FILES="
  index.html
  app.js
  config.json
...
with open('version.json') as f:
    data = json.load(f)
data['bundleUrl'] = 'https://map.octile.eu.cc/${OUT}'
